...
function superpixels = loadSuperpixels( options, shotid )

    file = fullfile( options.outfolder, 'superpixels', ...
        options.superpixels, sprintf( 'superpixelsShot%d.mat', shotid ) );
    if( exist( file, 'file' ) )
