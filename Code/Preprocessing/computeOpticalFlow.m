...
function flow = computeOpticalFlow( options, shot )
    ...
    fprintf( 'computeOpticalFlow: Processing shot #%d\n', shot );
    filename = fullfile( flowfolder, sprintf( 'flowShot%d.mat', shot ) );
    ...
    fprintf( 'computeOpticalFlow: Shot #%d finished processing\n', shot );
