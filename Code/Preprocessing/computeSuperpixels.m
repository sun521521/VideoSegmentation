...
function superpixels = computeSuperpixels( options, shot )
    ...
    fprintf( 'computeSuperpixels: Processing shot #%d\n', shot );
    filename = fullfile( superpixelfolder, ...
        sprintf( 'superpixelsShot%d.mat', shot ) );
    ...
    fprintf( 'computeSuperpixels: Shot #%d finished processing\n', shot );
